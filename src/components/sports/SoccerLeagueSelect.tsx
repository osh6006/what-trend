  ...
  return (
    <>
      <select
        ...
        className=" mx-auto block rounded-md border border-gray-300 bg-gray-50 px-2 py-3 text-lg focus:border-gray-500 focus:outline-none focus:ring-gray-500 lg:mx-0  "
      >
